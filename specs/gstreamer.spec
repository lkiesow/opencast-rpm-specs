...
# Remove RPath
chrpath --delete $RPM_BUILD_ROOT%{_libdir}/libgstbase-0.10.so.0.30.0
chrpath --delete $RPM_BUILD_ROOT%{_libdir}/libgstcheck-0.10.so.0.30.0
chrpath --delete $RPM_BUILD_ROOT%{_libdir}/gstreamer-0.10/libgstcoreindexers.so
chrpath --delete $RPM_BUILD_ROOT%{_libdir}/gstreamer-0.10/libgstcoreelements.so
