...
%define __INTERNAL_VERSION 1.5.0-rc2
...
Group: Applications/Multimedia
Requires: %{name}-base              = %{version}-%{release}
Requires: %{name}-third-party-tools = %{version}-%{release}
...
Requires: %{name}-module-matterhorn-authorization-manager = %{version}-%{release}
...
Requires: %{name}-module-matterhorn-userdirectory = %{version}-%{release}
...
Requires: %{name}-module-matterhorn-runtime-info-ui = %{version}-%{release}
Requires: %{name}-module-matterhorn-scheduler-api = %{version}-%{release}
Requires: %{name}-module-matterhorn-scheduler-remote = %{version}-%{release}
Requires: %{name}-module-matterhorn-series-service-api = %{version}-%{release}
...
Requires: %{name}-module-matterhorn-dublincore = %{version}-%{release}
Requires: %{name}-module-matterhorn-inspection-service-api = %{version}-%{release}
Requires: %{name}-module-matterhorn-inspection-service-mediainfo = %{version}-%{release}
Requires: %{name}-module-matterhorn-json = %{version}-%{release}
Requires: %{name}-module-matterhorn-kernel = %{version}-%{release}
Requires: %{name}-module-matterhorn-metadata-api = %{version}-%{release}
Requires: %{name}-module-matterhorn-mpeg7 = %{version}-%{release}
...
Group: Applications/Multimedia
Requires: %{name}-module-matterhorn-security-shibboleth = %{version}-%{release}
...
Group: Applications/Multimedia
Requires: %{name}-module-matterhorn-manager-api = %{version}-%{release}
Requires: %{name}-module-matterhorn-manager-impl = %{version}-%{release}

%package profile-alternatives
Summary: Alternatives profile for Opencast Matterhorn %{__INTERNAL_VERSION}
Group: Applications/Multimedia
Requires: %{name}-module-matterhorn-inspection-service-ffmpeg = %{version}-%{release}
...
Obsoletes: %{name}-module-matterhorn-inspection-service-ffmpeg < %{version}-%{release}
...
Provides:  %{name}-module-matterhorn-inspection-service-mediainfo = %{version}-%{release}
Obsoletes: %{name}-module-matterhorn-inspection-service-mediainfo < %{version}-%{release}
