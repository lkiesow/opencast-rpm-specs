...
Source0: x264-0.%{api}-%{snapshot}.tar.bz2
...
%package -n x264-devel
Summary: Development files for the x264 library
Requires: %{name}%{?_isa} = %{version}-%{release}
Requires: pkgconfig

%description -n x264-devel
x264 is a free library for encoding H264/AVC video streams, written from
scratch.
...
%changelog
* Wed Jul 13 2016 Lars Kiesow <lkiesow@uos.de> - 0.148-8.20160614gita5e06b9
- Adopted for x264-libs only build
